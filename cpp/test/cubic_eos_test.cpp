...
TEST(CubicEosTest, VanDerWaalsEosTest) {
  ...
  EXPECT_NEAR(eos.pressure(t, v[0]), 1.309708e6, 1.0);
  EXPECT_NEAR(eos.pressure(t, v[1]), 1.477564e5, 0.1);
  EXPECT_NEAR(eos.pressure(t, v[2]), 1.494696e4, 0.01);

  const auto line = eos.create_line(t);
  const auto p = line.pressure(v);

  EXPECT_NEAR(p[0], 1.309708e6, 1.0);
  EXPECT_NEAR(p[1], 1.477564e5, 0.1);
  EXPECT_NEAR(p[2], 1.494696e4, 0.01);
}
...
TEST(CubicEosTest, SoaveRedlichKwongEosTest) {
  ...
  EXPECT_NEAR(eos.pressure(t, v[0]), 1.283055e6, 1.0);
  EXPECT_NEAR(eos.pressure(t, v[1]), 1.474262e5, 0.1);
  EXPECT_NEAR(eos.pressure(t, v[2]), 1.494359e4, 0.01);

  const auto line = eos.create_line(t);
  const auto p = line.pressure(v);

  EXPECT_NEAR(p[0], 1.283055e6, 1.0);
  EXPECT_NEAR(p[1], 1.474262e5, 0.1);
  EXPECT_NEAR(p[2], 1.494359e4, 0.01);
}
...
TEST(CubicEosTest, PengRobinsonEosTest) {
  ...
  EXPECT_NEAR(eos.pressure(t, v[0]), 1.267541e6, 1.0);
  EXPECT_NEAR(eos.pressure(t, v[1]), 1.472064e5, 0.1);
  EXPECT_NEAR(eos.pressure(t, v[2]), 1.494132e4, 0.01);

  const auto line = eos.create_line(t);
  const auto p = line.pressure(v);

  EXPECT_NEAR(p[0], 1.267541e6, 1.0);
  EXPECT_NEAR(p[1], 1.472064e5, 0.1);
  EXPECT_NEAR(p[2], 1.494132e4, 0.01);
}